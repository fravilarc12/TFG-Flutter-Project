                    ...
                    return await showDialog(
                      ...
                      builder: (BuildContext context) {
                        return AlertDialog(
                          ...
                          content: Text(
                              '¿Estás seguro de que quieres eliminar el viaje a ${trip.destination}?'),
                          actions: [
                            TextButton(
                  ...
                  onDismissed: (direction) {
                    ...
                    if (idParaBorrar != null) {
                      ref
                          ...
                          .deleteTrip(idParaBorrar);

                      ScaffoldMessenger.of(context).showSnackBar(
                        SnackBar(
                          content:
                              Text('Viaje a ${trip.destination} eliminado'),
                        ...
                        children: [
                          ...
                          ClipRRect(
                            ...
                            child: CachedNetworkImage(
                              imageUrl:
                                  "https://maps.googleapis.com/maps/api/staticmap?center=${Uri.encodeComponent(trip.destination)}&zoom=11&size=450x225&maptype=terrain&key=${dotenv.env['GOOGLE_MAPS_API_KEY']}",
                              height: 160,
                              fit: BoxFit.cover,
                              memCacheWidth: 450,
                              memCacheHeight: 225,
